...
export class ContactService {
  ...
  public getById(id: string) {
    const contact = _contactsDb.find((contact) => contact._id === id);
  ...
  public _addContact(contact: Contact) {
    contact._id = this._makeId();
    _contactsDb.push(contact);
    this._contacts$.next(_contactsDb);
    return of(contact);
  }

  private _updateContact(contact: Contact) {
    const contacts = _contactsDb;
    const idx = contacts.findIndex((_contact) => _contact._id === contact._id);
